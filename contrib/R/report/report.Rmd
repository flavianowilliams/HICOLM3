...
```{r, echo=FALSE}
  ggplot()+
    geom_histogram(data=filter(thermo,data=='volume'),mapping=aes(value),binwidth = 10)+
    geom_histogram(data=filter(thermo,data=='temperature'),mapping=aes(value),binwidth = 5)+
    geom_histogram(data=filter(thermo,data=='pressure'),mapping=aes(value),binwidth = 30)+
    geom_histogram(data=filter(thermo,data=='energy'),mapping=aes(value),binwidth = 10)+
    geom_histogram(data=filter(thermo,data=='density'),mapping=aes(value),binwidth = 0.01)+
